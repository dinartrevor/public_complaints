	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="container data">
				<div class="row">
					<h1>Lihat Tanggapan</h1>
					<hr>
					<div class="col-sm-10 offset-sm-1">
            <form action="#" method="POST" enctype="multipart/form-data">
              <?php
              include '../config/koneksi.php';
              $sql = mysqli_query($koneksi,"SELECT * FROM pengaduan, tanggapan  WHERE tanggapan.pengaduan_id='$_GET[id]' AND tanggapan.pengaduan_id=pengaduan.id");
              $cek=mysqli_num_rows($sql);
              if ($cek<1)// lamun teu ka panggih
              {
            ...
            <a href="lihat_pengaduan.php" class="btn btn-primary">Kembali</a>
					</div>
				</div>
			</div>
		</div>
