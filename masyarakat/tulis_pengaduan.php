	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="container data">
				<div class="row">
					<h1>Silahkan tulis Pengaduan anda</h1>
					<hr>
					<div class="col-sm-10 offset-sm-1">
						<form action="pengaduan/simpan_pengaduan.php" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label >N I K</label>
								<input type="text" class="form-control" name="nik" value="<?php echo $_SESSION['nik'];?>">
								<!-- <small id="emailHelp" class="form-text text-muted">NIK dan nama lengkap akan disingkronkan.</small> -->
							</div>
							<!-- <div class="form-group">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="isi_laporan" rows="5" id="comment"></textarea>
							</div>
							<div class="form-group">
							...
							<input type="submit" name="submit" class="btn btn-primary btn-block" value="Kirim">
							<button type="reset" class="btn btn-warning btn-block"><span>Reset</span></button>
