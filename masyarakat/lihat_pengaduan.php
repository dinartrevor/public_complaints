...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="#"><em class="fa fa-briefcase">&nbsp;</em>Lihat Laporan</a></li>
			<hr>
      ...
      <div class="col-md-12 col-sm-12">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="detail-pengaduan.php?id=<?php echo $data['id']; ?>" class="btn btn-success">Detail</a>
                    <a href="lihat-tanggapan.php?id=<?php echo $data['id']; ?>" class="btn btn-primary" >Lihat Tanggapan</a>
                  </td>
                </tr>
              </tbody>
                  <?php } ?>
