...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
            ...
            <a href="proses.php?id=<?php echo $data['id'] ?>" class="btn btn-primary btn-block" onclick="return confirm('Yakin akan diproses');">Proses Verifikasi</a>
            <a href="verifikasi_pengaduan.php" class="btn btn-success btn-block">Kembali</a>
            <?php } ?>
					</div>
				</div>
			</div>
